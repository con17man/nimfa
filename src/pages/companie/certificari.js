      ...
      <div className="w-full relative">
        <div className="container relative mx-auto block lg:flex py-8 md:py-24 px-8 md:px-16 lg:px-0">
          ...
          <div className="block font-light text-sm tracking-wide md:pr-10">
            ...
            {/* CTA */}
            <a href={certificatePDF} download className="inline-block py-4 px-4 lg:px-16 mb-10 lg:mb-20 bg-orange-500 hover:bg-orange-700 text-white uppercase font-medium">
              {cta.label}
            </a>
